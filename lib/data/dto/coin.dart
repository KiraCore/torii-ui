...
class Coin extends Equatable {
  ...
  const Coin({required this.amount, required this.denom});
  ...
  factory Coin.fromJson(Map<String, dynamic> json) {
    return Coin(amount: json['amount'] as String, denom: json['denom'] as String);
  }

  Map<String, dynamic> toJson() {
    return <String, dynamic>{'amount': amount, 'denom': denom};
  }
