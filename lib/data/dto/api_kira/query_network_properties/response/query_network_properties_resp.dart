...
class QueryNetworkPropertiesResp extends Equatable {
  ...
  const QueryNetworkPropertiesResp({required this.properties});

  factory QueryNetworkPropertiesResp.fromJson(Map<String, dynamic> json) {
    return QueryNetworkPropertiesResp(properties: Properties.fromJson(json['properties'] as Map<String, dynamic>));
  }
