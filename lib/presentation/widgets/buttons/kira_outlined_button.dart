...
class KiraOutlinedButton extends StatelessWidget {
  ...
  const KiraOutlinedButton({
    ...
    this.trailing,
    super.key,
  }) : assert(width != null, 'width must be non-null (it won\'t show the button if width is null)');
        ...
        childBuilder: (Set<WidgetState> states) {
          return Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(color: _getBorderColor(states), width: 1),
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Text(
                  ...
                  style: textTheme.labelLarge!.copyWith(color: _getTextColor(states)),
                ),
  ...
  Color _getBorderColor(Set<WidgetState> states) {
    if (states.contains(WidgetState.hovered) && disabled == false) {
