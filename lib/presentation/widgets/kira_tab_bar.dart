...
class KiraTabBar extends StatelessWidget {
  ...
  const KiraTabBar({required this.tabController, required this.tabs, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: DesignColors.black, borderRadius: BorderRadius.circular(8)),
        child: TabBar(
          ...
          tabs:
              tabs.map((Tab tab) {
                return Tab(height: 30, text: tab.text ?? '');
              }).toList(),
        ),
      ),
    );
