...
import 'kira_context_menu_item.dart';
import 'kira_context_menu_item_layout.dart';
...
class KiraContextMenu {
  ...
  Future<void> show({required List<KiraContextMenuItem> kiraContextMenuItems, required Offset position}) async {
  ...
  Future<int?> _showContextMenu(Offset position, List<PopupMenuItem<int>> popupMenuItemsList) async {
    ...
    return showMenu<int>(
      ...
      position: RelativeRect.fromSize(position & const Size(48.0, 24.0), overlay.size),
    );
  }
}
