...
class _KiraSearchBar extends State<KiraSearchBar> {
  late final ValueNotifier<bool> clearButtonVisibleNotifier = ValueNotifier<bool>(
  ...
  Widget build(BuildContext context) {
          ...
          return TextFormField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: IconButton(
                icon: const Icon(AppIcons.search, color: DesignColors.grey1, size: 18),
              ...
              suffixIcon:
                  clearButtonVisible
                      ? Padding(
                        ...
                        child: IconButton(
                          icon: const Icon(AppIcons.cancel, color: DesignColors.accent, size: 18),
              ...
              focusedBorder: OutlineInputBorder(
                borderSide: const BorderSide(color: DesignColors.white1),
    ...
    if (widget.enabled == false) {
      searchBarWidget = Opacity(opacity: 0.4, child: IgnorePointer(child: searchBarWidget));
    }
