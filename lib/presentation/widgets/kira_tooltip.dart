...
class KiraToolTip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Tooltip(
      ...
      textStyle: textStyle ?? textTheme.bodySmall!.copyWith(color: DesignColors.white1),
      waitDuration: waitDuration,
      showDuration: showDuration,
      triggerMode: triggerMode,
      enableFeedback: enableFeedback,
      child: Padding(padding: childMargin, child: child ?? Icon(Icons.info_outline, color: iconColor, size: 17)),
    );
  }
}
