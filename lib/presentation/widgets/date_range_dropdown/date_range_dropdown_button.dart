...
//   const DateRangeDropdownButton({required this.onTap, this.startDateTime, this.endDateTime, Key? key})
//     : super(key: key);
...
//             border: Border.all(color: _selectBorderColor(states), width: 1),
//           ),
//           child: Row(
//             children: <Widget>[
...
//                   child: Text(_buildDateString(startDateTime), overflow: TextOverflow.ellipsis, style: dateTextStyle),
//                 ),
//               ),
...
//                   child: Text(_buildDateString(endDateTime), overflow: TextOverflow.ellipsis, style: dateTextStyle),
//                 ),
//               ),
//             ],
//           ),
...
//   Color _selectBorderColor(Set<WidgetState> states) {
//     if (states.contains(WidgetState.hovered)) {
