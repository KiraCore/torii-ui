...
part 'mnemonic_text_field_state.dart';
...
class MnemonicTextFieldCubit extends Cubit<MnemonicTextFieldState> {
  ...
  MnemonicTextFieldCubit({required this.index, required this.mnemonicGridCubit})
  ...
  void changeFocus({required bool textFieldFocusedBool}) {
    ...
    if (textFieldFocusedBool) {
      ...
      emit(
        MnemonicTextFieldState(mnemonicText: mnemonicWord, mnemonicTextFieldStatus: MnemonicTextFieldStatus.focused),
      );
    } else {
      mnemonicHintCubit.clearHint(placeholderVisibleBool: mnemonicWord.isEmpty);
      emit(MnemonicTextFieldState(mnemonicText: mnemonicWord, mnemonicTextFieldStatus: _getMnemonicTextFieldStatus()));
