...
class MnemonicGridGeneratedListItem extends StatelessWidget {
  ...
  const MnemonicGridGeneratedListItem({required this.index, required this.word, super.key});
        ...
        children: <Widget>[
          ...
          Expanded(
            child: Text(
              word,
              maxLines: 1,
              style: textTheme.bodySmall!.copyWith(color: DesignColors.white2, letterSpacing: 3),
            ),
          ),
        ],
      ),
