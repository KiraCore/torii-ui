...
import 'package:torii_client/domain/models/wallet/mnemonic/mnemonic_text_field_status.dart';
import 'package:torii_client/presentation/sign_in/mnemonic/hint/mnemonic_hint_cubit.dart';
import 'package:torii_client/presentation/sign_in/mnemonic/text_field/mnemonic_text_field_cubit.dart';
import 'package:torii_client/utils/exports.dart';

import 'mnemonic_text_field_layers_wrapper.dart';

class MnemonicTextField extends StatefulWidget {
  final MnemonicTextFieldCubit mnemonicTextFieldCubit;

  const MnemonicTextField({required this.mnemonicTextFieldCubit, super.key});
        ...
        return MnemonicTextFieldLayersWrapper(
          ...
          prefixWidget: Text(
            ...
            style: textTheme.bodySmall!.copyWith(
              color:
                  mnemonicTextFieldState.mnemonicTextFieldStatus == MnemonicTextFieldStatus.valid
            ...
            builder: (BuildContext context, MnemonicHintState mnemonicHintState) {
              return RichText(
                text: TextSpan(
                  ...
                  style: textTheme.bodySmall!.copyWith(letterSpacing: 3, color: Colors.transparent),
                  children: <TextSpan>[
                    TextSpan(
                      text: mnemonicHintState.hintText,
                      style: textTheme.bodySmall!.copyWith(letterSpacing: 3, color: DesignColors.white2),
                    ),
                  ],
                ),
              );
          ...
          editableWidget: EditableText(
            ...
            style: textTheme.bodySmall!.copyWith(letterSpacing: 3, color: DesignColors.white1),
          ),
        );
      },
    );
