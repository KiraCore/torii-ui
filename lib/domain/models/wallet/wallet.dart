...
import 'address/a_wallet_address.dart';
import 'address/cosmos_wallet_address.dart';
import 'address/ethereum_wallet_address.dart';
import 'mnemonic/mnemonic.dart' as torii;
...
class Wallet extends Equatable {
  ...
  const Wallet({required this.address, this.ecPrivateKey});
  ...
  factory Wallet.fromEthereumPrivateKey(String ethPrivateKey) {
    ...
    return Wallet(address: EthereumWalletAddress.fromPrivateKey(ecPrivateKey), ecPrivateKey: ecPrivateKey);
  }
  ...
  static Future<Wallet> derive({required torii.Mnemonic mnemonic, int lastDerivationPathSegment = 0}) async {
