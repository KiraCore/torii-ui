...
class TokenAmountModel {
  ...
  factory TokenAmountModel.fromString(String value) {
    ...
    return TokenAmountModel(defaultDenominationAmount: amount, tokenAliasModel: TokenAliasModel.local(denom));
  }

  TokenAmountModel copy() {
    return TokenAmountModel(defaultDenominationAmount: _defaultDenominationAmount, tokenAliasModel: tokenAliasModel);
  }
  ...
  void setAmount(Decimal amount, {TokenDenominationModel? tokenDenominationModel}) {
    ...
    bool defaultTokenDenominationBool =
        tokenDenominationModel == null || tokenDenominationModel == defaultTokenDenomination;
    if (defaultTokenDenominationBool) {
  ...
  TokenAmountModel operator +(TokenAmountModel tokenAmountModel) {
    ...
    return TokenAmountModel(defaultDenominationAmount: newAmount, tokenAliasModel: tokenAliasModel);
  }
