...
class EthereumKeyfileEntity extends AKeyfileEntity {
  ...
  const EthereumKeyfileEntity({required this.version, required this.id, required this.crypto});
  ...
  factory EthereumKeyfileEntity.fromJson(Map<String, dynamic> json) {
    try {
      ...
      getIt<Logger>().e('Error on EthereumKeyfileEntity.fromJson: $e');
  ...
  Map<String, Object> toJson() {
    return <String, Object>{'version': version, 'id': id, 'crypto': crypto.toJson()};
  }
...
class EthereumKeyfileCrypto extends Equatable {
  ...
  @override
  List<Object?> get props => <Object?>[ciphertext, cipherparams, cipher, kdf, kdfparams, mac];
}
...
class EthereumKeyfileKdfParams extends Equatable {
  ...
  const EthereumKeyfileKdfParams({required this.dklen, required this.salt, required this.c, required this.prf});

  Map<String, Object> toJson() {
    return <String, Object>{'dklen': dklen, 'salt': salt, 'c': c, 'prf': prf};
  }
